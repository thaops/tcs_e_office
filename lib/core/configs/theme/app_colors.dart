...
class AppColors {
  ...
  static const primary2 = Color.fromARGB(255, 255, 165, 0);
  ...
  static const bacgroundApp = Color(0xffF3F9FF);

  static const colorCall = Color(0xff5DD895);

  static const colorEmail = Color(0xffFF8284);

  static const colorMessageEnemy = Color(0xffE0F0FF);

  static const colorMessageMe = Color(0xffF4F4F4);

  static const colorComment = Color.fromRGBO(237, 237, 243, 1);

  static const colorbackgroundProfile = Color(0xffF3F9FF);

  static const colortextGray = Color.fromRGBO(113, 114, 122, 1);

  static const colorBackgroundGoogle = Color(0xffD2E9FF);

  static const success = Color(0xff00C853);

  static const colorBacklog = Color.fromRGBO(128, 128, 128, 1);

  static const inProgress = Color.fromRGBO(250, 140, 22, 1);

  static const colorDoing = Color.fromRGBO(20, 210, 3, 1);

  static const colorWaitingAndPending = Color.fromRGBO(138, 9, 95, 1);
  static const colorSpecification = Color.fromRGBO(224, 36, 199, 1);
  static const colorDevelopment = Color.fromRGBO(19, 194, 194, 1);
  static const colorInReview = Color.fromRGBO(5, 9, 141, 1);

  static const colorHigh = Color.fromRGBO(162, 86, 4, 1);
  static const colorMedium = Color.fromRGBO(233, 200, 82, 1);
  ...
  static const yellow = Color(0xffDA8503);
  static const black = Colors.black;
  static const colorIcon = Color(0xff8F9098);
  static const colorRed = Color(0xffED3241);
  static const colorRedBackground = Color(0xffFFE2E4);
  static final primaryOpacity = Color(0xffE0F7FB);
  static final orange = Color.fromRGBO(255, 166, 0, 0.498);
  static final backgroundTab = Color(0xffF8F9FE);
  ...
  static const colorReview = Color(0xFF4FC3F7); // Cyan
  static const colorGoLive = Color(0xFFE64A19); // Deep Orange
  static const colorOffice = Color(0xFF5D4037); // Brown
